package flysandwich.com.tutorial.item;

import flysandwich.com.tutorial.Tutorial;
...
public class ModItems {
    public static final Item PINK_GARNET=registerItem("pink_garnet",new Item(new Item.Settings()
            .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(Tutorial.MOD_ID,"pink_garnet")))));
